    ...
    while True:
        ...
        if choice == "3": #Exit
            ...
            while str(account_num) in list(data.keys()):
                ...
                account_num = "".join(account_num)
            view.new_account(account_num)

            account_num = model.Account(fname, lname, account_num, pin, initial)
            ...
            if model.Account.validate(account_num, pin) == False:
                view.bad_login()
